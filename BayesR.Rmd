...
BayesFitUnpooled<-sampling(modelUnpooled,chains=4,warmup=3000,iter=4000,control = list(max_treedepth = 14,adapt_delta=0.85))
...
BayesFitPooled<-sampling(modelPooled,chains=4,warmup=3000,iter=4000,control = list(max_treedepth = 14,adapt_delta=0.85))
